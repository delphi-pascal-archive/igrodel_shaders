...
begin
  if g_keys^.keyDown[VK_ESCAPE] then   // Is ESC Being Pressed?
    ...
    // передача кодов нажатых клавишь в unit1.pas
    move(g_keys^.keyDown,
         unit1keydown,
         length(g_keys^.keyDown));
...
begin                        // Fill Out Application Data
  ...
  window.init.title   := 'Optimized skeletal animation v1.2 (Turbo DELPHI / OpenGL 2.0)'; // Window Title
